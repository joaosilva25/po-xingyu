...
export const Button = ({
  ...
  const variants = {
    primary: "bg-white/90 hover:bg-white backdrop-blur-md text-zinc-900 border border-white/40 shadow-[0_0_40px_-10px_rgba(255,255,255,0.25)] hover:shadow-[0_0_60px_-15px_rgba(255,255,255,0.4)]",
